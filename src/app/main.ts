import "./styles.css";
import { AnalysisOptionsForm, analysisOptionsEqual } from "../analysis/analysisOptionsForm";
import { AnalysisCoordinator } from "../analysis/analysisCoordinator";
import { AppState } from "./appState";
import { AppRouter } from "./appRouter";
import { BrowseIndexStore, STATE_BROWSE_MAX_INTERSECTIONS, type BrowseIndex } from "../browse/browseIndex";
import { BrowseFilterWorkerClient } from "../browse/browseFilterWorkerClient";
import { BrowsePanelController } from "../browse/browsePanelController";
import { clustersCsv } from "../analysis/clusterCsvExport";
import { ClusterSelectionCoordinator, clusterSeverityKey } from "../selection/clusterSelectionCoordinator";
...
import { applyStaticTranslations, configureI18n, detectLocale, tr, trf, type AppLocale } from "../shared/i18n";
import {
  ...
  type LatLon
} from "../selection/intersectionUrlState";
...
import { SelectedIntersectionController } from "../selection/selectedIntersectionController";
import {
...
} from "../analysis/severityRankIndex";
import { STATE_NAMES } from "../domain/states";
import type { TelemetryMetadata } from "../shared/telemetry";
import { UnclusteredIncidentLayer } from "../map/unclusteredIncidentLayer";
import {
  AccidentRecord,
  AnalysisOptions,
  AnalysisResult,
