...
export const TRANSLATIONS: Record<AppLocale, Record<string, string>> = {
  en: {
    ...
    "intersectionFeature.caption":
      "Severity bars scale to the highest population group; rates are split into per-intersection and per-population tables",
    ...
    "intersectionFeature.perIntersection": "Per intersection",
    "intersectionFeature.perPopulation": "Per 100k municipality population",
    ...
    "intersectionFeature.totalPer100kPopulation": "Accidents per 100k municipality population",
    "intersectionFeature.fatalPer100kPopulation": "Fatal accidents per 100k municipality population",
    "intersectionFeature.seriousPer100kPopulation": "Serious accidents per 100k municipality population",
    ...
    "similar.classAll": "All road classes",
  ...
  de: {
    ...
    "intersectionFeature.caption":
      "Schweregrad-Balken skalieren zur hoechsten Einwohnerklasse; Raten sind in Tabellen je Kreuzung und je Einwohnerzahl getrennt",
    ...
    "intersectionFeature.perIntersection": "Je Kreuzung",
    "intersectionFeature.perPopulation": "Je 100k Gemeindeeinwohner",
    ...
    "intersectionFeature.totalPer100kPopulation": "Unfaelle je 100k Gemeindeeinwohner",
    "intersectionFeature.fatalPer100kPopulation": "Toedliche Unfaelle je 100k Gemeindeeinwohner",
    "intersectionFeature.seriousPer100kPopulation": "Schwere Unfaelle je 100k Gemeindeeinwohner",
    "intersectionFeature.populationUnder10k": "<10k",
    "intersectionFeature.population10k50k": "10k-50k",
    "intersectionFeature.population50k100k": "50k-100k",
    "intersectionFeature.population100k500k": "100k-500k",
    ...
    "similar.classAll": "Alle Strassenklassen",
