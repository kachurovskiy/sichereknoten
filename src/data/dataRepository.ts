...
import { analysisOptionsMetadataMatches, type SerializedAnalysisOptions } from "../analysis/analysisOptions";
...
export class DataRepository {
  ...
  private offlineBundleAssetBaseUrls(): string[] {
    const sourceModuleScript = document.querySelector<HTMLScriptElement>(
      'script[type="module"][src$="/src/app/main.ts"], script[type="module"][src$="src/app/main.ts"]'
    );
