...
import type { DataRepository, AnalysisCacheContext, DataRepositoryTelemetry } from "../data/dataRepository";
import { formatInteger } from "../shared/formatting";
import { tr, trf } from "../shared/i18n";
import type { LoadingStatusKind } from "../app/loadingStatusPresenter";
import { roadUserFocusKey } from "../domain/roadUsers";
import type { RequestGate, RequestToken } from "../app/requestGate";
import {
