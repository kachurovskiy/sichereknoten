import { accidentRecordRows, accidentSeverityLabel, accidentTimeLabel } from "../domain/accidentRecordDisplay";
import { ClusterAccidentRecordMatcher, type ClusterAccidentRecordsSnapshot, type CrossingAccident } from "../analysis/clusterAccidentRecords";
import { clusterStreetNamesForDisplay } from "../domain/clusterDisplay";
import { createFactsheetPdf, factsheetFileName, type CreateFactsheetPdfOptions } from "./factsheet";
import { tr, trf } from "../shared/i18n";
import type { LoadingStatusKind } from "../app/loadingStatusPresenter";
import { RequestGate } from "../app/requestGate";
import { errorMessage, type TelemetryMetadata } from "../shared/telemetry";
import type { AccidentRecord, AnalysisOptions, AnalysisResult, ClusterYearStat, IntersectionCluster } from "../domain/types";
import type { SetViewOptions } from "../app/appRouter";
import {
