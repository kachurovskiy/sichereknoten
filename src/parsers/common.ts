...
export function accidentFromRecord(
  ...
  return {
    ...
    osmRoundaboutId: osmRoadMetadata.roundaboutId,
    osmRoundaboutLon: osmRoadMetadata.roundaboutLon,
    osmRoundaboutLat: osmRoadMetadata.roundaboutLat,
    osmRoundaboutRadiusMeters: osmRoadMetadata.roundaboutRadiusMeters,
    osmRoundaboutMatchRadiusMeters: osmRoadMetadata.roundaboutMatchRadiusMeters,
