...
export const TRANSLATIONS: Record<AppLocale, Record<string, string>> = {
  en: {
    ...
    "similar.noRoadClasses": "No road class has at least {count} intersections in the current filters.",
    ...
    "similar.noLargeGroups": "No comparison group has at least {count} intersections for this road class.",
  ...
  de: {
    ...
    "similar.noRoadClasses": "In den aktuellen Filtern hat keine Strassenklasse mindestens {count} Kreuzungen.",
    ...
    "similar.noLargeGroups": "Keine Vergleichsgruppe hat mindestens {count} Kreuzungen fuer diese Strassenklasse.",
